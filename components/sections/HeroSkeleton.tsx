...
export function HeroSkeleton() {
  return (
    ...
    >
      {/* ── Background image ─────────────────────────────────────────────
          Photo: Northern lights above snow-capped glacier
      ...
      <div className="absolute inset-0" aria-hidden="true">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-ice-black via-ice-black/60 to-ice-navy/35" />
        <div className="absolute inset-0 bg-gradient-to-b from-ice-black/25 via-transparent to-transparent" />
      </div>
