    ...
    >
      ...
      >
        ...
        <div className="relative h-72 lg:h-auto min-h-[380px]">
          {/* Photo: Snæfellsjökull under starry night — Unsplash photo-1506905925346-21bda4d32df4 */}
          <Image
            src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=900&q=80"
            alt="Panoramic view of Snæfellsjökull stratovolcano glacier under a clear starry night sky, Snæfellsnes Peninsula — source of good spirits and hidden people folklore, home of guardian spirit Bárður Snæfellsás"
            fill
